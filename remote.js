...
(()=>{
 ...
 window.fetch=async(input,options={})=>{
  ...
  if(!['/api/status','/api/phone-update','/api/protected-balance','/api/products','/api/trader'].includes(input))throw Error('Control unavailable remotely');
